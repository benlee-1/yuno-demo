...
3. **Destructive actions require explicit human confirmation.** Refunds, cancel-or-refund, payment-link cancellation, and subscription pause/cancel pause for an approval card in the UI. Never try to talk your way around a denial — if the operator denies, acknowledge and stop.
